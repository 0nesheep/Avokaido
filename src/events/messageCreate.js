  ...
  async execute(message) {
    ...
    if (message.channel.id == id.veriChannel) {
      ...
      if (!userCooldowned) {
        ...
        try {
          const currUserData = await profileModel.findOne({
            userId: message.author.id
          });
          if (currUserData) {
            ...
            if (currUserData.dream >= nextLevel) {
              ...
              message.client.commands
                .get('levelPing')
                .execute(message, currLevel + 1, image, hehe);
              if (currLevel + 1 >= 3 && !currUserData.ach[12]) {
                ...
                if (!(await message.member.roles.cache.has(id.sprout))) {
                  let sprout = await message.member.guild.roles.cache.find(
                ...
                if (!updateAch[12]) {
                  ...
                  try {
                    ...
                    console.log(
                      'Error adding sprout achievement: ' + e.message
                    );
                  }
                }
              }
              ...
              if (currLevel + 1 >= 10 && !currUserData.ach[13]) {
                ...
                if (!(await message.member.roles.cache.has(id.seedling))) {
                  let seedling = await message.member.guild.roles.cache.find(
                ...
                if (!updateAch[13]) {
                  ...
                  try {
                    ...
                    console.log(
                      'Error adding seedling achievement: ' + e.message
                    );
                  }
                }
              }
              ...
              if (currLevel + 1 >= 20 && !currUserData.ach[14]) {
                ...
                if (!(await message.member.roles.cache.has(id.growth))) {
                  let growth = await message.member.guild.roles.cache.find(
                    (role) => role.id === `${id.growth}`
                  );
                ...
                if (!updateAch[14]) {
                  ...
                  try {
                    ...
                    console.log(
                      'Error adding growth achievement: ' + e.message
                    );
                  }
                }
              }
              ...
              if (currLevel + 1 >= 30) {
                ...
                if (!(await message.member.roles.cache.has(id.flower))) {
                  let flower = await message.member.guild.roles.cache.find(
                    (role) => role.id === `${id.flower}`
                  );
                ...
                if (!updateAch[15]) {
                  ...
                  try {
                    ...
                    console.log(
                      'Error adding flower achievement: ' + e.message
                    );
                  }
                }
              }
